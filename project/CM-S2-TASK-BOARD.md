...
|---------|---------|------|----|-----------|-----|-----|-------------|--------|
| CM-S2-01 | FDD-TOOL-CODEMAP | BE: Git diff integration — `codebase-map diff HEAD~1` changed + impacted nodes | 3 | CM-S2-design #cm-s2-01 | Day 1 | — | — | 🔄 In Progress |
...
| **Total** | **18** | **11 tasks** | **0 PRs** | | **🔄 0/11 Done (0/18 SP)** |
