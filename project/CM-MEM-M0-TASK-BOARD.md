...
| **Status** | 🔥 **ACTIVE** — Day 1 ✅ MERGED (PR #44) · Day 2 ✅ MERGED (PR #45, 99/100) · Day 3 READY · 5/8 SP (62%) · 09/04/2026 |
...
| 4 | KMP-M0-04 | Setup import-linter CI rule (Core ↛ Vertical) | 0.5 | D3 | 🟢 READY | CI fail khi cố ý vi phạm (test commit) |
| 5 | KMP-M0-05 | Build `verticals/hello/` reference ≤ 50 LOC + `verticals/hello/README.md` | 1 | D3-4 | 🟢 READY | Hello vertical chạy end-to-end, sinh patterns.md; README ≤ 5 phút đọc |
